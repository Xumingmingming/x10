public class Setting {
	...
	//生命游戏设定
	public static val Agent_Quantity:Int=20000 as Int;//Agent初始数量
	public static val Iteration_Step=5 as Int;//生命游戏迭代次数
	//public static val File_Location="../DataCollection/" as String;//数据收集位置
	public static val File_Location="F:/DataCollection/" as String;//数据收集位置
